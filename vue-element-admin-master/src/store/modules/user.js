  ...
  getInfo({ commit, state }) {
    ...
    return new Promise((resolve, reject) => {
      getInfo(state.token).then(response => {
        ...
        //添加头像时可以const { roles, name,userface:avatar, introduction } = data
        // const { roleId, name, avatar, introduction } = data
        // const { roleId:roleId, name:name, avatar, introduction } = data
        const { realname:name, avatar, introduction } = data
