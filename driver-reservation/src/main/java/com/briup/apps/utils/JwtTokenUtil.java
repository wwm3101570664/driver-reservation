...
public class JwtTokenUtil {
     ...
     * @return
     */
    public static String createJWT(Long userId, String username,Integer roleId) {
        try {
            // 使用HS256加密算法
          ...
          //roleId是重要信息，进行加密下
            ...
            JwtBuilder builder = Jwts.builder().setHeaderParam("typ", "JWT")
                    ...
                    .claim("userId", encryId).claim("roleId", encryId2)
                    // 代表这个JWT的主体，即它的所有人
                    .setSubject(username)
                    // 代表这个JWT的签发主体；
                    .setIssuer(clientId)
    ...
    public static String getRoleId(String token, String base64Security){
        String roleId = parseJWT(token, base64Security).get("roleId", String.class);
        //System.out.println(roleId);
        return Base64Util.decode(roleId);
    }
